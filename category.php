    ...
    <!-- Nav -->
      <nav id="nav">
        <ul class="links">
          ...
          <li class="active"><a>Types of rooms</a></li>
        </ul>
      </nav>
        ...
        <ul class="pagination justify-content-center mb-4">
          <li class="page-item">
            <?php 
                ...
                ?>
            <a style="text-decoration: none;"class="button large" class="page-link" href="category.php?catid=<?= $view_category_id; ?>&page=<?php echo $previous ?>">&larr; Previous</a>
             <?php } ?>
          </li>
          <li class="page-item">
            <?php 
                if ($page < $allpages)
                  {
                    $next= $page + 1;
              ?>
            <a style="text-decoration: none;"class="button large" class="page-link" href="category.php?catid=<?= $view_category_id; ?>&page=<?php echo $next ?>">Next &rarr;</a>
            <?php } ?>
          </li>
        </ul>
